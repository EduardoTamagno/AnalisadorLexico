...
function handleLabel(erroEstado){ //avisa erro ou acerto 
...
function setRowClass(id, valor){ //define linha pintada
    document.getElementById(id).className = valor;
}

function handleCellClass(processo, id, valor){  //define celula pintada
...
function preencherLista(){  //processo de add tokem 
...
function adicionarToken(token, divTokens){   //add token na listaTokens
...
function criarTabela(){ //preenche tabela com lista de token
...
function adicionarListaTokens(valor){  //valida palavra digitada
...
function limparInput(){ // limpa o campo de texto
